    ...
    <nav className="bg-gray-800 text-gray-200 p-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <Link to="/coding-profiles" className="hover:text-gray-400">Coding Profiles</Link>
      ...
      {isOpen && (
        <div className="md:hidden mt-2">
          <div className="flex flex-col space-y-2">
            ...
            <Link onClick={() => setIsOpen(false)} to="/coding-profiles" className="block hover:text-gray-400">Coding Profiles</Link>
